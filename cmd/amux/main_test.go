	...
	tests := []struct {
		...
		},
		{
			...
			want: []string{
				...
				"\"spawn:Create one projectless local physical-host worker\"",
		...
		},
		{
			...
			want: []string{
				...
				"complete -c amux -f -n '__fish_use_subcommand' -a 'spawn' -d 'Create one projectless local physical-host worker'",
				...
				"complete -c amux -f -n 'test (__fish_amux_root_command) = worker; and test -z (__fish_amux_worker_leaf)' -a 'spawn' -d 'Create one projectless local physical-host worker'",
