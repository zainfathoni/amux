	...
	tests := []struct {
		...
		},
		{
			...
			want: []string{
				...
				"\"spawn:Prepare, arm, or finalize one native local assignment\"",
		...
		},
		{
			...
			want: []string{
				...
				"complete -c amux -f -n '__fish_use_subcommand' -a 'spawn' -d 'Prepare, arm, or finalize one native local assignment'",
				...
				"complete -c amux -f -n 'test (__fish_amux_root_command) = worker; and test -z (__fish_amux_worker_leaf)' -a 'spawn' -d 'Prepare, arm, or finalize one native local assignment'",
