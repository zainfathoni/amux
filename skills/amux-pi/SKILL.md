...
- The bounded task packet is supplied over stdin, never process argv. Receipts record requested-model launch evidence, not provider-side model or billing proof; post-run admission and transactional rollback must succeed before completion.
