...
| `Recover indeterminate Claude worker evidence` | [`claude-delegation-recovery.md#explicit-legacy-registration-and-indeterminate-worker-detach`](claude-delegation-recovery.md#explicit-legacy-registration-and-indeterminate-worker-detach) | Explicit owner-authorized registration/detach only; the pre-identity compatibility selector never infers missing executable/argv identity; preserve unresolved evidence and fence, never rewrite, kill, retry, park, or clean. |
