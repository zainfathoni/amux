...
| `Recover indeterminate Claude worker evidence` | [`claude-delegation-recovery.md#explicit-legacy-registration-and-indeterminate-worker-detach`](claude-delegation-recovery.md#explicit-legacy-registration-and-indeterminate-worker-detach) | Explicit owner-authorized registration/detach only; preserve unresolved evidence and fence, never infer, kill, retry, park, or clean. |
